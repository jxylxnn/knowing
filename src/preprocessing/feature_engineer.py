...
class FeatureEngineer:
    ...
    def __init__(self, rolling_windows: Optional[List[int]] = None, use_gpu: bool = True):
        self.rolling_windows = rolling_windows if rolling_windows is not None else [3, 5, 10, 20, 50]
